export const Process = () => {
    const features = [
        {
            title: "Scope Identification & Management",
            icon:(
        ...
        {
            title: "Coordination of Consultants & Site Meetings",
            icon:(
                <svg data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        {
            title: "Planning & Schedule Baselines",
            icon:(
                <svg data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        {
            title: "Cost Management & Baselines",
            icon:(
                <svg data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        {
            title: "Approving Payment Certificates",
            icon:(
                <svg data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        {
            title: "Programming & Client Needs Analysis",
            icon:(
                <svg data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        {
            title: "Contractor & Subcontractor Coordination",
            icon:(
                <svg data-slot="icon" fill="none" stroke-width="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <div className="bg-pri">
            <section>
                <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
                    <h2 className="text-center mb-6 text-sec">
                    Our Core Responsibilities in Project Management


                    </h2>
                    <p className="text-center text-gray-400">
                    At Milestone, we cover all essential aspects of project management, ensuring every task is meticulously handled to guarantee project success. Below are key responsibilities we manage to ensure smooth project execution:
                    </p>
                </div>

                {/* Adjusted Grid */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:mx-auto lg:max-w-screen-xl">
                    {features.map((feature, index) => (
                        <div key={index} className="relative h-full ml-0 mr-0 sm:mr-10 flex flex-col justify-center items-center">
                        <span className={`absolute top-0 left-0 w-full h-full mt-1 ml-1 bg-sec rounded`}></span>
                        <div className="relative w-full h-full  border rounded bg-white flex items-center p-4">
                            <div className="mr-4 h-10 w-10">{feature.icon}</div>
                            <span className="">
